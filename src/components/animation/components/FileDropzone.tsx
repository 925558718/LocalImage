import { ChevronUp, ImageIcon, Info, Trash2, Upload } from "lucide-react";
...
export default function FileDropzone({
	...
	const renderEmptyDropzone = () => (
		...
		>
			...
			<h3 className="text-lg font-semibold text-foreground mb-2">
				{isDragActive ? t("drop_files_here") : t("drag_or_click_upload")}
			</h3>
	...
	const renderFilesList = () => (
		<div className="bg-card rounded-xl border border-border shadow-sm flex flex-col h-full">
			...
			<button
				{...getRootProps()}
				className="cursor-pointer flex-1 flex flex-col border-0 bg-transparent p-0"
			...
			>
				...
				<div
					className={`flex-1 overflow-y-auto ${isDragActive ? "bg-primary/10" : ""} max-h-[400px]`}
				>
