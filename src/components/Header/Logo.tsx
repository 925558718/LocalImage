					...
					>
						...
						<span className="relative inline-block">
							...
							<span className="absolute inset-0 opacity-60">
								{/* 慢速旋转的X - 表示持续变换 */}
								<span className="absolute inset-0 animate-spin-slow text-primary/20 scale-125">
									X
								</span>
								{/* 脉冲缩放的X - 表示动态变化 */}
								<span className="absolute inset-0 animate-pulse text-primary/30 scale-150">
									X
								</span>
								{/* 快速闪烁的X - 表示瞬间转换 */}
								<span className="absolute inset-0 animate-ping text-primary/25">
									X
								</span>
								{/* 波纹扩散效果 - 表示影响扩散 */}
								<span className="absolute inset-0 animate-ripple text-primary/15 scale-200">
									X
								</span>
							</span>
