...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
	...
	// 标题和描述支持多语言
	const title = dictionary.meta_title || "WebP Animation Creator - LocalImage | Convert Images";
	const description = dictionary.meta_description || "Free online WebP and GIF animation creator. Convert multiple images into high-quality animations with local processing. No uploads required, privacy protected.";
	...
	return {
		title,
		description,
		keywords: dictionary.meta_keywords || "WebP animation, GIF creator, animation creator, image to animation, online animation tool",
...
export default async function RootLayout({
	...
	// 动态生成结构化数据
	const appName = dictionary.structured_data_app_name || "LocalImage WebP Animation Creator";
	const appDescription = dictionary.structured_data_description || "Free online WebP animation creator. Convert multiple images into high-quality animations";
