      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="mt-6 p-4 bg-muted/50 rounded-lg">
            <h4 className="font-medium mb-2">{t('codec_html_explanation')}</h4>
            <div className="text-sm text-muted-foreground space-y-2">
              <p>{t('codec_html_explanation_1')}</p>
              <p>{t('codec_html_explanation_2')}</p>
              <p>{t('codec_html_explanation_3')}</p>
              <p>{t('codec_html_explanation_4')}</p>
              
              <div className="mt-3 p-3 bg-background rounded border">
                <h5 className="font-medium text-foreground mb-2">{t('codec_base64_example')}</h5>
                <div className="space-y-1 text-xs">
                  <div><span className="text-red-600">{t('codec_base64_original')}</span> &lt;script&gt;alert(&quot;XSS&quot;)&lt;/script&gt;</div>
                  <div><span className="text-green-600">{t('codec_base64_encoded')}</span> &amp;lt;script&amp;gt;alert(&amp;quot;XSS&amp;quot;)&amp;lt;/script&amp;gt;</div>
                </div>
              </div>
            </div>
          </div>
